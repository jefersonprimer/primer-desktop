  ...
  return (
    <div className={`relative flex flex-col justify-between p-6 bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-2xl border border-white/10 ${className}`}>
      ...
      <div>
        <button
          onClick={onJoinDemo}
          className="bg-white text-black px-4 py-2 rounded-xl font-semibold text-sm hover:bg-gray-200 transition-all active:scale-[0.98] shadow-lg shadow-white/5 flex items-center gap-2"
        >
          Join demo meeting
        </button>
      </div>
