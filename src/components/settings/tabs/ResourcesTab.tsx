...
export default function ResourcesTab() {
  ...
  return (
    <div className="bg-white dark:bg-[#1D1D1F] text-gray-500 dark:text-neutral-400 h-full overflow-y-auto p-8">
      <div className="mb-8">
        <h1 className="text-xl font-semibold text-gray-900 dark:text-white">{t("resources.title")}</h1>
        ...
        <div className="bg-gray-50 dark:bg-[#242425] rounded-lg p-4 mb-3">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-gray-900 dark:text-white">
              {t("resources.autoScroll.subtitle")}
            </h3>
            <button
          ...
          <p className="text-sm leading-relaxed">
            {t("resources.autoScroll.description")}
          </p>
        </div>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <h2 className="text-base font-semibold text-gray-900 dark:text-white">{t("resources.selectToPrompt.title")}</h2>
        </div>

        <div className="bg-gray-50 dark:bg-[#242425] rounded-lg p-4 mb-3">
          <div className="flex items-center justify-between mb-3">
            <span className="text-sm text-gray-900 dark:text-white flex items-center gap-2">
              {t("resources.selectToPrompt.subtitle")}
          ...
          <p className="text-sm leading-relaxed">
            {t("resources.selectToPrompt.description")}
          </p>
        </div>
      </div>
    </div>
